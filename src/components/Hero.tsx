...
export const Hero = () => {
  ...
  const openResume = () => {
    window.open('https://drive.google.com/file/d/1uj6G2NReGYVTSP0YV6TlYfsWd_Kl_3yu/view?usp=sharing', '_blank');
  };
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center py-20">
      <div className="text-center z-10 max-w-4xl mx-auto px-4">
        ...
        <h2 className="text-2xl md:text-3xl text-gray-400 mb-6 max-w-3xl mx-auto leading-tight">
          Backend Software Engineer - Designing event-driven systems, data pipelines, and reliability layers for production-scale cloud platforms.
        </h2>

        <div className="flex flex-wrap justify-center gap-3 mb-8">
          {['Event-Driven ETL', 'Reliability Engineering', 'Cloud Automation'].map((chip) => (
            <span key={chip} className="px-4 py-2 bg-bat-gray/50 border border-bat-yellow/30 rounded-full text-bat-yellow text-sm font-medium backdrop-blur-sm">
              {chip}
            </span>
          ))}
        </div>
